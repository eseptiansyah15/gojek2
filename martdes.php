...
echo "\n";
        ...
        sleep(10);
         ...
         $code1 = requestedd('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PEJUANG2020"}');
...
echo "\n".color("green","👌🍱 Ambil Voucer ");
        ...
        $code1 = requestedd('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HARBOLNAS"}');
...
echo "\n".color("green","👌🍱 Ambil Voucer ");
        ...
        $code1 = requestedd('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOODDES19"}');
        $message = fetch_value12($code1,'"message":"','"');
        if(strpos($code1, 'Promo kamu sudah bisa dipakai')){
        echo "\n".colorss("green","👍🙏 Message: ".$message);
        }else{
    ...
    echo color("nevy","  SEMOGA CUAN,  SCRIPT BY AS04 \n");   
